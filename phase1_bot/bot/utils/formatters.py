...
INSTRUCTIONS_TEXT = (
    ...
    "6️⃣ Buyer sends funds to the escrow deposit address.\n"
...
def format_welcome_dm(stats: Dict[str, int]) -> str:
    ...
    return (
        ...
        f"• Stay connected — our official channel for news and announcements: {VERIFICATION_CHANNEL}\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"📊 *Track record:*\n"
...
def format_transaction_summary(deal: Dict[str, Any]) -> str:
    ...
    return (
        ...
        "_Tap to copy_\n\n"
        f"📣 Stay connected — our official channel for news and announcements:\n"
